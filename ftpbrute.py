...
def main():
    try:
        ...
        if check_port(target) == True:
            ...
            print('\033[1;91m[!]\033[37m The port 21 is not open.. please try again later or take a nmap scan\033[0m')
            main()

    except KeyboardInterrupt:
        print()
        print("Exiting... Ftp Brute")
        exit()
...
def check_userlist(target):
    try:
        username = str(input('\033[1;96m[-]\033[37m Enter the path of username list: \033[0m'))
